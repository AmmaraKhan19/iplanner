  ...
  const getNotes = async () => {
    ...
    const response = await fetch(`${host}/api/notes/fetchallnotes`, {
      ...
      headers: {
        ...
        "auth-token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoiNjQxMTc3MDY2MjIzYjQwZmJmNGIxM2E1In0sImlhdCI6MTY4MTIxMzk1N30.bTdOtBR12ykj2avsCF8y6K6B7vhxKXseiiW2SJv9yb0"
      }, 
    });
